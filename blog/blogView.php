        ...
        <div class="blog__comment">
            ...
            <?php
                foreach($commentResult as $comment){ ?>
                    <div class="comment__view" id="commnet<?=$comment['commentID']?>">
                        <div class="avatar">
            ...
            <div class="comment_write">
                <form action="#">
                    <fieldset>
                        ...
                        <textarea type="text" id="commentWrite" name="commentWrite" placeholder="댓글을 써주세요." maxlength="255" required></textarea>
